...
interface GenerateContactLinksProps {
  contactLinks: ContactLinksProps[];
}

function ContactHeroHeader() {
  return (
...
function GenerateContactLink({ contactLinks }: GenerateContactLinksProps) {
...
export default function GenerateContactHero() {
  ...
  return (
    <div className='helpContainer'>
      <ContactHeroHeader />
      <GenerateContactLink contactLinks={contactLinks} />
    </div>
  );
}
